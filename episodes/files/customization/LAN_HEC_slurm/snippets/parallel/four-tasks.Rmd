...
# (mpi4py and numpy are in conda forge repo)
module load `r config$remote$modules$python`

# When installing Python modules it's best to do so in a venv.
conda create -p $global_storage/mpi-test
source activate $global_storage/mpi-test
