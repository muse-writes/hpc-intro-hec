...
Try downloading the file directly. On the HEC, you *can* access the wider
internet from login nodes, but this is not universal.
...
[amdahl-git-repo]: https://github.com/hpc-carpentry/amdahl
